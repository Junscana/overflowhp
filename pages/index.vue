<template>
  <main class="home">
    <h1 class="key-visual">
      <img src="~/assets/images/kv/kv__coming-soon--sp.jpg" alt="OVERFLOWアーティスト写真" class="sp">
      <img src="~/assets/images/kv/kv__coming-soon--pc.jpg" alt="OVERFLOWアーティスト写真" class="pc">
    </h1>
